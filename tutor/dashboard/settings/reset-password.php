	...
	<form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="tutor-row">
            <div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-7 tutor-mb-32">
                <label class="tutor-form-label tutor-color-secondary"> <?php esc_html_e('Obecne hasło', 'tutor'); ?> </label>
                <input class="tutor-form-control" type="password" name="previous_password" placeholder="Obecne hasło">
            </div>
        </div>
			...
			<div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-7 tutor-mb-32">
				<div class="tutor-password-field tutor-settings-pass-field">
					<label class="field-label tutor-form-label" for="tutor-confirm-password">
						<?php esc_html_e( 'Powtórz hasło', 'tutor' ); ?>
					</label>
