			...
			<?php
				...
				if ( $time_limit ) :
					...
					$available_time_type = array(
						'sekundy'	=> $time_limit>1 ? __( 'Sekundy', 'tutor' ) : __( 'Sekunda', 'tutor' ),
						'minuty'	=> $time_limit>1 ? __( 'Minuty', 'tutor' ) : __( 'Minuta', 'tutor' ),
						'godziny'		=> $time_limit>1 ? __( 'Godziny', 'tutor' ) : __( 'Godzina', 'tutor' ),
						'dni'		=> $time_limit>1 ? __( 'Dni', 'tutor' ) : __( 'Dzień', 'tutor' ),
						'tygodnie'		=> $time_limit>1 ? __( 'Tygodnie', 'tutor' ) : __( 'Tydzień', 'tutor' ),
					);
			?>
				<div class="tutor-quiz-info">
