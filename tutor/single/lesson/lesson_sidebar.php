...
<div class="tutor-course-single-sidebar-title tutor-d-flex tutor-justify-between">
	<span class="tutor-fs-6 tutor-fw-medium tutor-color-secondary"><?php _e("", "tutor"); ?></span>
							...
							<a href="<?php echo $show_permalink ? get_permalink($quiz->ID) : '#'; ?>" data-quiz-id="<?php echo $quiz->ID; ?>">
								...
								<div class="tutor-d-flex tutor-ml-auto tutor-flex-shrink-0">
									...
									if ($time_limit) {
										...
										$time_type == 'minuty' ? $time_limit = $time_limit * 60 : 0;
										$time_type == 'godziny' ? $time_limit = $time_limit * 3660 : 0;
										$time_type == 'dni' ? $time_limit = $time_limit * 86400 : 0;
										$time_type == 'tygodnie' ? $time_limit = $time_limit * 86400 * 7 : 0;
