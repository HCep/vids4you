...
<div class="tutor-wrap tutor-wrap-parent tutor-dashboard tutor-frontend-dashboard tutor-dashboard-student tutor-pb-80">
	<div class="tutor-container">
		...
		<?php  if (user_verification_is_verified($approved_status))
	 { ?>
		...
		<?php	}else{ ?>
			<a class="tutor-col-12 hidden-on-mobile" href="<?php echo home_url(); ?>" style="padding:30px; display:block; font-size:20px; background-color:#e4605e; width:100%; display:flex; justify-content:center;">
						
						<span>Konto nie zweryfikowane. Proszę najpierw zweryfikować adres mailowy. Nie zapomnij sprawdzić folderu spam.</span>
					</a>
				<?php } ?>
	</div>
	...
	<div id="tutor-dashboard-footer-mobile">
	 ...
	 if (user_verification_is_verified($approved_status))
	{
	   
	 ?>
				<?php foreach ($footer_links as $link) : ?>
					<a class="tutor-col-6 <?php echo $link['is_active'] ? 'active' : ''; ?>" href="<?php echo $link['url']; ?>">
						<i class="<?php echo $link['icon_class']; ?>"></i>
						<span><?php echo $link['title']; ?></span>
					</a>
				<?php endforeach;
				}else{ ?>
				<a class="tutor-col-12" href="<?php echo home_url(); ?>" style="padding:30px; display:block; font-size:20px background-color:#e4605e; width:100%; display:flex; justify-content:center;">
